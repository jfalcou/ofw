...
enum class operations { def_ctor, move_ctor, move_assign, copy_ctor, copy_assign };
struct ctor_tracker
{
  ...
  ctor_tracker& operator=(ctor_tracker&&)       { value = operations::move_assign; return *this; }
  ctor_tracker& operator=(ctor_tracker const&)  { value = operations::copy_assign; return *this; }
};
